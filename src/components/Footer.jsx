        ...
        <footer className="w-full bg-gray-500 text-white text-sm leading-[22px] font-ptsans">
            <div className="max-w-[980px] mx-auto px-[10px] py-6 flex flex-col md:flex-row justify-between gap-6">
                ...
                <div className="space-y-1 mt-6">
                    ...
                    <a href="mailto:l4212550@gmail.com" className="underline">
                        l4212550@gmail.com
                    </a>
                </div>
                ...
                <ul className="space-y-1 mt-6">
                    ...
                    <li>
                        <Link to="/Catalog" onClick={() => window.scrollTo(0, 0)} className="hover:underline">
                            Каталог
                        </Link>
                    </li>
                    <li>
                ...
                <div className="flex items-center gap-2 mt-6">
                    <img src={FooterLogo} alt="CompanyLogo" className="w-9 h-9" />
